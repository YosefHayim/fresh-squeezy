 ...
 */
export const runAugmentCommand = async (options: AugmentCommandOptions = {}): Promise<number> => {
...
const detectFlavour = async (cwd: string, force: boolean): Promise<Flavour> => {
...
const renderAugmentationFile = (flavour: Flavour): string => {
  const header = `/**
